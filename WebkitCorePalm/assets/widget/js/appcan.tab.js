appcan.define("tab", function($, exports, module) {
    ...
    <%if(option.hasLabel){%><div class="ulev-18 tx-c"><%=data.label%></div><%}%>\
    </div>\
    <div class="ulev-2 headColor " id="<%="badge_"+index%>"><%if(option.hasBadge && data.badge){%><div class="red tab_badge ub-ac ub-pc ub ulev0 badge"><%=data.badge%></div><%}%></div>\
    </div>';
